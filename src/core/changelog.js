...
const VOIDFALL_CHANGELOG=[
 {version:2026091705,date:'SEPTEMBER 17, 2026',title:'EMBERLIGHT',intro:'The threshold now burns with the same warmth as the Ember.',changes:['Cyan title-screen accents have been replaced with aged gold, bronze, warm ivory, and restrained ember-orange.','The chamber stone, gate aperture, orbiting shards, menu borders, icons, and focus states now share the warmer palette.','Violet remains reserved for Ember Forms and Essence so those systems keep their own identity.','Layout, progress, saves, controls, and gameplay are unchanged.']},
