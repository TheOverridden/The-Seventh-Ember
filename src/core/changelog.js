...
const VOIDFALL_CHANGELOG=[
 {version:2026091601,date:'SEPTEMBER 16, 2026',title:'FALLING LIGHT',intro:'VoidFall has a real score and an interface rebuilt for the descent.',changes:['A complete original song now carries one synchronized melody, harmony, counterline, percussion, and a deep rolling bass through the entire game.','Each region reshapes the same central theme into its own musical movement, while Guardians intensify the arrangement without abandoning the song.','Music now starts from the title screen, develops in four-part form, and reacts smoothly to exploration, crowded rooms, and boss fights.','Music and effects have separate volume controls, and existing mute controls still work.','Menus, HUD, dialogue, blessing cards, Skill Tree, settings, and run screens now share a sharper ember-and-spectral interface with clearer hierarchy and interaction states.','Phone, tablet, Chromebook, desktop, short-screen, portrait, and landscape layouts reorganize around the available space.','Gameplay balance and progression are unchanged. Existing saves automatically receive sensible volume defaults.']},
 ...
 {version:2026091503,date:'SEPTEMBER 15, 2026',title:'A FALSE ALARM SILENCED',intro:'The game will no longer mistake harmless browser events for an unknown error.',changes:['Removed the persistent “Error: unknown” notice caused by message-less browser events.','Real script failures still produce a useful message, can be dismissed, and disappear automatically after ten seconds.','Repeated copies of the same error are suppressed so they cannot cover the game.','Existing saves and progression are preserved.']},
