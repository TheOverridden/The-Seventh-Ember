...
const DEF_SAVE = ()=>({v:1, progressionEpoch:SAVE_PROGRESSION_EPOCH, essence:0, nodes:{}, bestFloor:0, bestLevel:0, totalRuns:0, totalKills:0, totalEssence:0, victories:0, guardians:0, tut:0, music:1, sfx:1, musicVolume:.82, sfxVolume:.86, motion:0, touch:0, quality:"full", resume:null});
let save = DEF_SAVE();
